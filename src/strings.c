...
const u8 gText_MainMenuNewGame[] = _("NOVA AVENTURA");
...
const u8 gText_Option[] = _("M E N Ú   D ' O P C I O N S");
const u8 gText_TextSpeed[] = _("VEL. TEXT");
const u8 gText_BattleScene[] = _("ANIMACIONS");
const u8 gText_BattleStyle[] = _("ESTIL");
const u8 gText_Sound[] = _("SO");
const u8 gText_Frame[] = _("CANTONADES");
const u8 gText_OptionMenuCancel[] = _("ENRERE");
...
const u8 gText_BattleStyleShift[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}CANVIAR");
const u8 gText_BattleStyleSet[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MANTENIR");
...
const u8 gText_FrameType[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Marc");
